...
def getUrlData(url, p_tpye):
    ...
    click, clickSucc, clickFaild, clickTimeOut, clickSave, clickSaveFaild, clickWrong, cvt, cvtCamp, clickFound, clickFoundFaild, report, reportMatch, reportSucc, reportFaild, reportException, clickException, clickParamError, clickAdidWrong = listpro(
        ptpye)
    return click, clickSucc, clickFaild, clickTimeOut, clickSave, clickSaveFaild, clickWrong, cvt, reportMatch, reportSucc, reportFaild, clickFoundFaild, reportException, clickException, clickParamError, clickAdidWrong
